#!/usr/bin/env python3
"""Validate the cumulative Philippines v16 ledger without earlier live cases."""
...
ARCHIVE = PACKAGE / "muio" / "Philippines_v16_v16.0.0_MUIO.zip"
REPORT = PACKAGE / "diagnostics" / "canonical_schema_ledger_validation_v16.json"
...
def main() -> int:
    ...
    def current_archive() -> dict[str, object]:
        rows = read_csv(LEDGER / "V16_MODEL_ARCHIVE_MANIFEST.csv")
        ...
        required = {
            "Philippines_v16/genData.json", "Philippines_v16/RYT.json",
            "Philippines_v16/RYTEM.json", "Philippines_v16/RYTCM.json",
            "Philippines_v16/RYTCn.json", "Philippines_v16/RYCn.json",
            "Philippines_v16/documentation/national_water_manifest.json",
            "Philippines_v16/documentation/national_water_validation.json",
        }
    ...
    check("current_v16_model_archive", current_archive)
    ...
    report = {
        ...
        "validator": "Philippines_v16_CLEWs_build/scripts/validate_philippines_v16_canonical_ledger.py",
        "ledger_dir": "Philippines_v16_CLEWs_build/data_sources",
        "model_archive": "Philippines_v16_CLEWs_build/muio/Philippines_v16_v16.0.0_MUIO.zip",
