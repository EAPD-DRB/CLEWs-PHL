#!/usr/bin/env python3
"""Create the review workbook from the authoritative Philippines v17 CSVs."""
...
OUTPUT = LEDGER / "PHILIPPINES_V17_CANONICAL_SCHEMA_LEDGER.xlsx"
TABLES = [
...
def main() -> None:
    ...
    index.append(["Philippines v17 canonical cumulative schema ledger"])
    index.append(["Authority", "The six CSV files beside this workbook are authoritative; this workbook is a review copy."])
    index.append(["Scope", "Inherited base + v13 calibration + v14 stock turnover + v15 national water + complete v16 repairs + v17 national land-cover accounting"])
