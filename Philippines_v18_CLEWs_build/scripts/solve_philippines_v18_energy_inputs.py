#!/usr/bin/env python3
"""Generate, solve and export the Philippines v18 canonical BASE case."""
...
def main() -> None:
    ...
    response = model.createCaseRun(
        args.run,
        {
            ...
            "Desc": "Full-chain validation of Philippines v18 energy inputs with inherited land safeguards",
