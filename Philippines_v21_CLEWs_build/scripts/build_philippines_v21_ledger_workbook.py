#!/usr/bin/env python3
"""Create the review workbook from the authoritative Philippines v21 CSVs."""
...
OUTPUT = LEDGER / "PHILIPPINES_V21_CANONICAL_SCHEMA_LEDGER.xlsx"
...
def main() -> None:
    ...
    index.append(["Philippines v21 canonical cumulative schema ledger"])
    index.append(["Authority", "The six CSV files beside this workbook are authoritative; this workbook is a review copy."])
    index.append(["Scope", "Complete inherited provenance through v20 plus the v21 endogenous power-allocation repair."])
