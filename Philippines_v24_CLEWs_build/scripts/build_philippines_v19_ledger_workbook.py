#!/usr/bin/env python3
"""Create the review workbook from the authoritative Philippines v19 CSVs."""
...
OUTPUT = LEDGER / "PHILIPPINES_V19_CANONICAL_SCHEMA_LEDGER.xlsx"
...
def main() -> None:
    ...
    index.append(["Philippines v19 canonical cumulative schema ledger"])
    index.append(["Authority", "The six CSV files beside this workbook are authoritative; this workbook is a review copy."])
    index.append(["Scope", "Complete inherited provenance through v18 plus the v19 additional endogenous PM2.5 factors for existing technologies."])
