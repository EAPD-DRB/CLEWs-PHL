#!/usr/bin/env python3
"""Create the review workbook from the authoritative Philippines v20 CSVs."""
...
OUTPUT = LEDGER / "PHILIPPINES_V20_CANONICAL_SCHEMA_LEDGER.xlsx"
...
def main() -> None:
    ...
    index.append(["Philippines v20 canonical cumulative schema ledger"])
    index.append(["Authority", "The six CSV files beside this workbook are authoritative; this workbook is a review copy."])
    index.append(["Scope", "Complete inherited provenance through v19 plus the v20 minimal endogenous power-history calibration."])
