#!/usr/bin/env python3
"""Generate, solve, and export the Philippines v19 BASE case."""
...
DEFAULT_MUIOGO = PACKAGE.parents[1].parents[1]
DEFAULT_CASE = "Philippines_v19"
DEFAULT_RUN = "PM25_COVERAGE_V19_BASE"
...
def main() -> None:
    ...
    response = model.createCaseRun(
        args.run,
        {
            ...
            "Desc": "Full-chain validation of the Philippines v19 PM2.5 coverage extension",
    ...
    print(json.dumps({"status": status, "case": str(case), "run": str(run),
