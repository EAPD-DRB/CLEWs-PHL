...
## Philippines v25 VariableCost candidate (2026-08-25)

The cumulative six-table ledger now includes 240 changed VariableCost tech-mode
maps and 40 explicit land-mode KEEP maps. The complete upstream Claude package,
new PSA/DOE extracts, arithmetic and cell ledger are under
`variable_cost_v25_2026-08-25/`. Scenario validation is explicitly pending.
